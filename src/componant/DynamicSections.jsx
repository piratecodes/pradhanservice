...
const SectionBadge = ({ badge }) => {
  ...
  return (
    <div className={`w-auto inline-flex items-center gap-2 px-4 py-1.5 rounded-full font-black text-[10px] tracking-[0.2em] border border-slate-200/50 bg-white/40 backdrop-blur-md shadow-sm mb-6 ${textColor}`}>
