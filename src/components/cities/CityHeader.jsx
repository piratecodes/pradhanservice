...
export default function CityHeader({ onOpenDrawer, searchQuery, onSearchChange }) {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
      <div>
        <h1 className="text-3xl font-extrabold text-primary tracking-tight">The Network</h1>
        <p className="text-gray-500 font-medium mt-1">Manage operational cities and routes.</p>
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="relative w-full md:w-64 hidden sm:block">
          ...
          <input
            type="text"
            placeholder="Search cities or sub-towns..."
            value={searchQuery} // 👈 Wired up!
            onChange={(e) => onSearchChange(e.target.value)} // 👈 Wired up!
